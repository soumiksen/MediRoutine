...
const PatientProfilePage = () => {
  ...
  return (
    <div className="min-h-screen p-4" style={{ backgroundColor: 'var(--color-remedy-primary)' }}>
      {/* Main Content */}
      <div className="max-w-4xl mx-auto pt-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold mb-2" style={{ color: 'var(--color-remedy-secondary)' }}>
            {profileData.name}
          </h2>
        ...
        <div className="rounded-2xl p-8 mb-6" style={{ 
          ...
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-2xl font-semibold" style={{ color: 'var(--color-remedy-secondary)' }}>
        ...
        <div className="rounded-2xl p-8 mb-6" style={{ 
          ...
          <h3 className="text-2xl font-semibold mb-6" style={{ color: 'var(--color-remedy-secondary)' }}>
